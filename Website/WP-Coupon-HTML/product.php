...
<head>
    ...
    <!-- Title Tag
    ========================================================================= -->
    <title>MFD - An Advanded Coupon Codes and Deals Template</title>
            ...
            <div class="container">
                ...
                <div class="header_right fright">
                    <form id="header-search">
                        ...
                        <div class="clear"></div>
                        <div class="search-sample"><span>Top Searches:</span> <a href="#">Athletefor</a>,  <a href="#">Kmart</a>,  <a href="#">Macy’s</a>,  <a href="#">SmoothThemes</a>,  <a href="#">ThemeForest</a> ...</div>
                    </form>
                </div>
            </div>
        </div> <!-- END .header -->
            ...
            <div class="container">
                <nav class="primary-navigation clearfix fleft">
                    ...
                    <ul class="st-menu wpc-menu">
                        <li class="menu-item-has-children"><a href="#"><i class="unordered list icon"></i> Browse Coupons</a>
                            <div class="nav-toggle-subarrow"><i class="plus icon"></i></div>
                            <ul class="sub-menu">
                                <li><a href="category_az.html">Browse by Categories</a></li>
                                <li><a href="store_az.html">Browse by Stores</a></li>
                                <li><a href="#"># Printable Coupons <i class="print icon"></i></a></li>
                        ...
                        <!-- <li class=""><a href="#"><i class="student icon"></i> Back To School</a></li> -->
                        <li class="">
        ...
        <section class="custom-page-header single-store-header">
            <div class="container">
                <div class="ui small breadcrumb">
                    ...
                    <i class="right angle right icon divider"></i>
                    <div class="active section">Nature</div>
                </div>
                <div class="inner shadow-box">
                    <div class="inner-content clearfix">
                        <div class="header-thumb">
                            <div class="header-store-thumb">
                                <a href="#"><img src="thumb/stores/nature.png" alt=""></a>
                            </div>
                            <a class="add-favorite" href="#"><i class="empty heart icon"></i><span>Favorite This Store</span></a>
                        </div>
                        <div class="header-content">
                            <h1><strong>Nature </strong>Coupon Code and Deals</h1>
                            <p> Nature is the world's largest department store with top fashion brands including Michael Kors and more - it's the place you probably think of first when you go shopping in stores or online.</p>
                ...
                <main id="main" class="site-main">
                    <section class="coupon-filter">
                        <div class="ui pointing fluid four item menu">
                            <a class="active item filter-nav">All <span class="offer-count">100</span></a>
                            <a class="item filter-nav">Codes <span class="offer-count code-count">20</span></a>
                            <a class="item filter-nav">Sales <span class="offer-count sale-count">40</span></a>
                            <a class="item filter-nav">Prinable <span class="offer-count print-count">40</span></a>
                        </div>
                    </section>
                    ...
                    <section id="coupon-listings-wrapper" class="wpb_content_element">
                        <div class="store-listings">
                            ...
                            <div class="store-listing-item coupon-listing-item shadow-box">
                                ...
                                <div class="latest-coupon">
                                    <h3 class="coupon-title"><a href="#">HTC DESIRE 816</a></h3>
                                    <div class="c-type">
                                        <span class="c-code">Code</span> <span class="exp">Expires 6/25/2015</span>
                                    </div>
                                    <div class="coupon-des">
                                        Save with free shipping and free returns on all orders of $99. Some <span class="des-more">... <a href="#">More<i class="angle down icon"></i></a></span> <span class="coupon-des-full"> exclusions apply. No code required. Limited time offer.<a class="des-less" href="#">Less<i class="angle up icon"></i></a></span>
                                    </div>
                                </div>
                                <div class="coupon-detail coupon-button-type">
                                  <a href="#" class="coupon-deal coupon-button flip" data-aff-url="http://www.flipkart.com/">Flipkart</a><br>
                                   <a href="#" class="coupon-deal coupon-button flip" data-aff-url="http://www.flipkart.com/">Snapdeal</a> </br>									 <a href="#" class="coupon-deal coupon-button flip" data-aff-url="http://www.flipkart.com/">Amazon</a>
                                ...
                                <div class="coupon-footer coupon-listing-footer">
                                    <ul class="clearfix">
                                        <li><span><i class="wifi icon"></i> 268 Used - 16 Today</span></li>
                                    ...
                                    <div class="reveal-content reveal-comments">
                                        ...
                                        <div class="ui threaded comments">
                                            <div class="comment">
                                                <a class="avatar">
                                                    <img src="thumb/avatars/avatar1.jpg">
                                                </a>
                                                <div class="content">
                                                    ...
                                                    <div class="text"><p>Gave me 15% on my already sale priced item</p></div>
                                                    <div class="actions">
                                                ...
                                                <div class="comments">
                                                    <div class="comment">
                                                        <a class="avatar">
                                                            <img src="thumb/avatars/avatar2.jpg">
                                                        </a>
                                                        <div class="content">
                                                            ...
                                                            <div class="text">
                                                                <p>That item was excluded from offer. </p>
                                                            </div>
                                                            <div class="actions">
                                                                <a class="reply">Reply</a>
                                                            </div>
                                            ...
                                            <div class="comment">
                                                <a class="avatar">
                                                    <img src="thumb/avatars/avatar3.jpg">
                                                </a>
                                                <div class="content">
                                                    ...
                                                    <div class="text"><p>Total savings $21.44 on Women's active wear</p></div>
                                        ...
                                        <form action="">
                                            <div class="ui form">
                                                ...
                                                <button class="ui button btn btn_primary">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div id="coupon_id_1" class="ui modal coupon-modal coupon-code-modal">
                                    <div class="coupon-header clearfix">
                                        ...
                                        <div class="coupon-title">HTC DESIRE 816</div>
                                        <span class="close"></span>
                                    </div>
                                    <div class="coupon-content">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <a href="http://www.flipkart.com/" target="_blank" class="ui button btn btn_secondary go-store">Go To Store<i class="angle right icon"></i></a>
                                        </div>
                                        <div class="clearfix">
                        ...
                        </div><!-- END .store-listings -->						</section>
                    ...
                    <div class="six wide column">
                        <aside class="widget">
                            <div class="widget_content">
                                <p><a href="#"><img src="assets/images/logo.png" alt=""></a></p>
...
<script src="assets/ST-User/js/user.js"></script>
