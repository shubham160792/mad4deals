...
<body>
	<div class="container">
		...
		<a class="tiny button" href="{{ URL::to(Config::get('app.url_path').'caption/create') }}" style="float:left;">Create a Caption</a>
				...
				<tbody>
					...
					<tr>
						...
						<div class="row">
							...
							<a class="tiny button" href="{{ URL::to(Config::get('app.url_path').'caption/' . $value->id . '/edit') }}" >Edit</a>
							</div>
							<div class="small-2 large-4 columns" style="float:left;">
								{{ Form::open(array('url' => Config::get('app.url_path').'caption/' . $value->id)) }}
